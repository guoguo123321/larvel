...
<body>
    <div class="bk_title_bar">
        <img class="bk_back" src="/images/back.png"alt="返回" onclick="history.go(-1)"/>
        <p class="bk_content">xxx</p>
        <img class="bk_list" src="/images/list.png"onclick="onMenuClick();" alt="列表"/>
    </div>
